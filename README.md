# מטלה 0 - סימולטור שרידות סטודנט

מטלה זו היא ללא ניקוד, ונועדה ל"ניסוי כלים" בלבד - לבדוק שאתם מצליחים להשתמש במערכת ההגשה והבדיקה האוטומטית.

במטלה זו תתבקשו להשלים קוד חסר בקבצים המממשים את המחלקה `Student`. המחלקה מדמה סטודנט שנה א' ומנהלת את מצבו הנפשי לאורך הסמסטר — כמות הקפה שצרך, מספר המטלות הפתוחות, שעות השינה, ורמת הפאניקה הכללית.

## דרישות והנחיות

- ליצור ולממש את הקבצים הנדרשים
