...
TIDY_FLAGS=-checks=bugprone-*,-bugprone-easily-swappable-parameters,clang-analyzer-*,cppcoreguidelines-*,performance-*,portability-*,-portability-avoid-pragma-once,readability-* --warnings-as-errors=*
